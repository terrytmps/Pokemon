...
class PokemonFactory:
    ...
    def create_brasegali():
        ...
        return (
            Pokemon.Builder()
            .set_name("Braségali")
            .set_img(  "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/257.png")
            .set_level(1, XPDifficulty.HARD)
            .set_stat(stat)
            .set_price(45)
            .set_type(PokemonType.FIRE)
    ...
    def create_aquali():
        ...
        return (
            Pokemon.Builder()
            .set_name("Aquali")
            .set_img("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/134.png")
            .set_level(1, XPDifficulty.NORMAL)
            .set_stat(stat)
            .set_price(30)
            .set_type(PokemonType.WATER)
    ...
    def create_herbizarre():
        ...
        return (
            Pokemon.Builder()
            .set_name("Herbizarre")
            .set_img("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/2.png")
            .set_level(1, XPDifficulty.NORMAL)
            .set_stat(stat)
            .set_price(20)
            .set_type(PokemonType.GRASS)
    ...
    def create_chrysacier():
        ...
        return (
            Pokemon.Builder()
            .set_name("Chrysacier")
            .set_img("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/11.png")
            .set_level(1, XPDifficulty.NORMAL)
            .set_stat(stat)
            .set_price(7)
    ...
    def create_evoli():
        ...
        return (
            Pokemon.Builder()
            .set_name("Évoli")
            .set_img("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/133.png")
            .set_level(1, XPDifficulty.NORMAL)
            .set_stat(stat)
            .set_price(15)
            .set_type(PokemonType.NORMAL)
    ...
    def create_voltali():
        ...
        return (
            Pokemon.Builder()
            .set_name("Voltali")
            .set_img("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/135.png")
            .set_level(1, XPDifficulty.HARD)
            .set_stat(stat)
            .set_price(40)
            .set_type(PokemonType.ELECTRIC)
    ...
    def create_pyroli():
        ...
        return (
            Pokemon.Builder()
            .set_name("Pyroli")
            .set_img("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/136.png")
            .set_level(1, XPDifficulty.HARD)
            .set_stat(stat)
            .set_price(35)
            .set_type(PokemonType.FIRE)
    ...
    def create_noctali():
        ...
        return (
            Pokemon.Builder()
            .set_name("Noctali")
            .set_img("https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/197.png")
            .set_level(1, XPDifficulty.HARD)
            .set_stat(stat)
            .set_price(40)
            .set_type(PokemonType.DARK)
    ...
    def get_all_staticmethod():
        ...
        return [
            getattr(PokemonFactory, func) for func in dir(PokemonFactory)
